        ...
        <div class="content">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                ...
                <div
                    ...
                    <img src="vannila-ice-cream.jpg" alt="Vanilla Ice Cream" width="100%" height="150px" style="border-radius: 10px;">
                ...
                <div
                    style="width: 250px; background-color: #f7f7f7; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <img src="strawberry-ice-cream.jpg" alt="Strawberry Ice Cream" width="100%" height="150px" style="border-radius: 10px;">
                ...
                <div
                    style="width: 250px; background-color: #f7f7f7; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <img src="blueberry-ice-cream.jpg" alt="Blueberry Ice Cream" width="100%" height="150px" style="border-radius: 10px;">
                ...
                <div
                    style="width: 250px; background-color: #f7f7f7; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <img src="mango-ice-cream.jpg" alt="Mango Ice Cream" width="100%" height="150px" style="border-radius: 10px;">
